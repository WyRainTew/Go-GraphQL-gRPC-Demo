...
const file_user_proto_rawDesc = "" +
	...
	"\x03sex\x18\x04 \x01(\tR\x03sex2M\n" +
	"\vUserService\x12>\n" +
	"\vGetUserInfo\x12\x15.grpc.UserInfoRequest\x1a\x16.grpc.UserInfoResponse\"\x00B\x17Z\x15Demo/internal/grpc/pbb\x06proto3"
...
var file_user_proto_goTypes = []any{
	(*UserInfoRequest)(nil),  // 0: grpc.UserInfoRequest
	(*UserInfoResponse)(nil), // 1: grpc.UserInfoResponse
}
var file_user_proto_depIdxs = []int32{
	0, // 0: grpc.UserService.GetUserInfo:input_type -> grpc.UserInfoRequest
	1, // 1: grpc.UserService.GetUserInfo:output_type -> grpc.UserInfoResponse
